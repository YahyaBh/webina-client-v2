...
const PageUnavailable = () => {
    ...
    useEffect(() => {
        const handleMouseMove = (event) => {
            const maxX = 1000; // maximum x-coordinate within the box
            const maxY = 1000; // maximum y-coordinate within the box
            const minX = -1500;   // minimum x-coordinate within the box
            const minY = -1500;   // minimum y-coordinate within the box

            const newX = Math.max(minX, Math.min(event.clientX, maxX));
            const newY = Math.max(minY, Math.min(event.clientY, maxY));

            setCursorPosition({ x: newX * .05, y: newY * .05 });
    ...
    return (
        <div id='error-container'>
            ...
            <svg className='error-eyes' viewBox="0 0 975 415" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_312_28879)">
                    <path
                        ...
                        fill="#FFE662" />
                    <path
                        d="M632.659 208.129C632.659 279.464 620.493 331.916 596.999 365.066C573.085 398.215 536.586 415 487.081 415C438.834 415 402.754 397.796 378.002 362.968C353.668 328.14 341.502 276.527 341.502 208.129C341.502 136.375 353.249 83.9231 377.582 50.3539C401.495 16.7846 437.995 0 487.5 0C535.327 0 571.827 17.6239 596.16 52.452C620.493 87.2801 632.659 138.893 632.659 208.129ZM449.742 208.129C449.742 253.868 452.679 285.339 458.133 302.123C464.006 319.328 473.236 327.72 486.661 327.72C500.086 327.72 509.736 318.908 515.609 301.284C521.063 283.66 524 252.609 524 208.129C524 163.231 521.063 132.179 515.609 114.135C509.736 96.092 500.506 87.2801 487.081 87.2801C473.656 87.2801 464.006 96.092 458.552 113.296C452.679 130.501 449.742 161.972 449.742 208.129Z"
                        fill="#FFE662" />
                    <path
                        d="M975 331.077H930.529V409.125H822.709V331.077H662.027V251.35L829.841 5.87451H930.529V249.671H975V331.077ZM823.128 249.671V202.674C823.128 193.862 823.548 182.113 823.967 167.007C824.807 151.901 825.226 144.348 825.646 143.508H822.709C816.416 157.775 809.284 170.783 801.313 183.372L756.422 250.091H823.128V249.671Z"
                        fill="#FFE662" />
                </g>
                <g clipPath="url(#clip1_312_28879)">
                    <path
                        d="M594.206 218.661C627.119 218.661 653.8 191.942 653.8 158.983C653.8 126.023 627.119 99.3047 594.206 99.3047C561.293 99.3047 534.612 126.023 534.612 158.983C534.612 191.942 561.293 218.661 594.206 218.661Z"
                        fill="white" />
                    <path
                        d="M398.139 218.661C431.052 218.661 457.734 191.942 457.734 158.983C457.734 126.023 431.052 99.3047 398.139 99.3047C365.226 99.3047 338.545 126.023 338.545 158.983C338.545 191.942 365.226 218.661 398.139 218.661Z"
                        fill="white" />
                    <path
                    ...
                    <path
                        ...
                        fill="#EFEFEF" />
                    <path
                        d="M398.139 221.48C363.806 221.48 335.808 193.442 335.808 159.061C335.808 124.679 363.806 96.6416 398.139 96.6416C432.472 96.6416 460.471 124.679 460.471 159.061C460.471 193.442 432.472 221.48 398.139 221.48ZM398.139 102.046C366.778 102.046 341.282 127.577 341.282 158.982C341.282 190.388 366.778 215.919 398.139 215.919C429.5 215.919 454.996 190.388 454.996 158.982C454.996 127.655 429.5 102.046 398.139 102.046Z"
                        fill="#231F20" />
                    <g id='error' transform={`matrix(1, 0, 0, 1, ${cursorPosition.x}, ${cursorPosition.y})`}>
                        <path
                    ...
                    <path
                        d="M594.206 221.48C559.873 221.48 531.875 193.442 531.875 159.061C531.875 124.679 559.873 96.6416 594.206 96.6416C628.539 96.6416 656.538 124.679 656.538 159.061C656.538 193.442 628.539 221.48 594.206 221.48ZM594.206 102.046C562.845 102.046 537.349 127.577 537.349 158.982C537.349 190.388 562.845 215.919 594.206 215.919C625.567 215.919 651.063 190.388 651.063 158.982C651.063 127.655 625.567 102.046 594.206 102.046Z"
                        fill="#231F20" />
                    <g transform={`matrix(1, 0, 0, 1, ${cursorPosition.x}, ${cursorPosition.y})`}>
                        <path
                            d="M 568.972 171.94 C 584.911 171.94 597.831 159.001 597.831 143.041 C 597.831 127.08 584.911 114.141 568.972 114.141 C 553.034 114.141 540.114 127.08 540.114 143.041 C 540.114 159.001 553.034 171.94 568.972 171.94 Z"
                            fill="#231F20" />
                        <path
                            d="M 561.191 149.619 C 567.713 149.619 573 144.324 573 137.793 C 573 131.262 567.713 125.967 561.191 125.967 C 554.669 125.967 549.381 131.262 549.381 137.793 C 549.381 144.324 554.669 149.619 561.191 149.619 Z"
                            fill="white" />
                    </g>
                    <path
                        d="M321.887 77.8453C331.976 89.4363 341.048 68.4472 372.253 61.8685C398.296 56.3863 414.563 69.4654 419.099 59.5973C423.635 49.7293 402.832 35.9454 364.51 42.0542C335.964 46.5183 310.156 64.3747 321.887 77.8453Z"
                        fill="white" />
                    <path
                        d="M669.677 79.7251C658.962 90.7679 651.063 69.3089 620.249 61.0072C594.519 54.1153 577.548 66.2545 573.559 56.1515C569.571 46.0486 591.078 33.4394 629.009 41.5845C657.32 47.6932 682.112 66.881 669.677 79.7251Z"
                        fill="white" />
                    <path
            ...
            <Link href='/'><AiOutlineHome /> GO HOME</Link>
